...
def generate(data_type="train",
    ...
    root = os.path.abspath('dataset/blackbeans/')

    if not box_size % 2 == 1:
        raise Exception("Please choose odd box_size")

    if data_type == "test":
        im_path = root + '/sample_1.jpg'
        centres_path = root + '/annotations/blackbeans_1.mat'
        neg_path = root + '/annotations/negative_samples_1.mat'
    elif data_type == "train":
        im_path = root + '/sample_2.jpg'
        centres_path = root + '/annotations/blackbeans_2.mat'
        neg_path = root + '/annotations/negative_samples_2.mat'
    elif data_type == "validation":
        im_path = root + '/sample_3.jpg'
        centres_path = root + '/annotations/blackbeans_3.mat'
        neg_path = root + '/annotations/negative_samples_3.mat'
    else:
        raise Exception('Data type is either "train" or "validation" or "test"')
